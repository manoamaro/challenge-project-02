...
RSpec.describe ContactsController, type: :controller do
  ...
  let(:valid_attributes) {
    {first_name: 'Contact 01', last_name: 'Last name 01', email: 'email01@email.com', user: @user}
  }

  let(:invalid_attributes) {
    {first_name: 'Contact 01', last_name: 'Last name 01', email: nil, user: @user}
  }
  ...
  describe "PUT #update" do
    context "with valid params" do
      let(:new_attributes) {
        { first_name: 'Other name 01', last_name: 'other last name 02', email: 'email02@email.com' }
      }
      ...
      it "updates the requested contact" do
        ...
        contact.reload
        expect(contact.first_name).to eq('Other name 01')
        expect(contact.last_name).to eq('other last name 02')
        expect(contact.email).to eq('email02@email.com')
      end
