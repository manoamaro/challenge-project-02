...
RSpec.describe CustomFieldsController, type: :controller do
  ...
  let(:valid_attributes) {
    { title: 'Custom field 01', field_type: :text, user: @user }
  }

  let(:invalid_attributes) {
    { title: nil, field_type: :text }
  }
  ...
  describe "PUT #update" do
    context "with valid params" do
      let(:new_attributes) {
        { title: 'Custom field 02', field_type: :textarea, default_value: '123456' }
      }
      ...
      it "updates the requested custom_field" do
        ...
        custom_field.reload
        expect(custom_field.title).to eq('Custom field 02')
        expect(custom_field.field_type).to eq('textarea')
        expect(custom_field.default_value).to eq('123456')
      end
